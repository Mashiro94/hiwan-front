<template>
	<view class="index">
		<uni-card v-for="(item, index) in list" :key="index" :isShadow="true" :title="item.name" :subTitle="item.date" thumbnail="/static/latest/latest_3.jpg" mode="title" :extra="item.beginTime" note="true" @click="goDetail">
			<view>
